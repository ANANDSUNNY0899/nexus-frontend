...
//       } else {
//         console.error("[Nexus] Checkout URL not received:", data)
//         setUpgradeError(true)
//       }
//     } catch (err) {
//       console.error("[Nexus] Checkout redirect failed:", err)
//       setUpgradeError(true)
//     }
//   }
...
//       <div className="max-w-[1440px] mx-auto p-8 lg:p-10 space-y-8">
//         <DashboardHeader />
...
//       <footer className="max-w-[1440px] mx-auto px-8 lg:px-10 py-8 border-t border-white/5">
